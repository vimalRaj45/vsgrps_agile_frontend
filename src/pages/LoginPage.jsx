              ...
              <form onSubmit={handleSubmit}>
                <Stack spacing={2.5}>
                  <TextField
                    ...
                    InputProps={{ 
                      startAdornment: <EmailIcon sx={{ mr: 2, color: 'rgba(255,255,255,0.5)', fontSize: 22 }} />,
                    }}
                    InputLabelProps={{ shrink: true }}
                    sx={{ 
                      '& .MuiOutlinedInput-root': { 
                        bgcolor: 'rgba(255,255,255,0.02)', borderRadius: 3, height: 64, color: 'white',
                        '& fieldset': { borderColor: 'rgba(255,255,255,0.1)' },
                        '&:hover fieldset': { borderColor: 'rgba(255,255,255,0.2)' },
                        '&.Mui-focused fieldset': { borderColor: '#818cf8', borderWidth: '2px' }
                      }, 
                      '& .MuiInputLabel-root': { color: '#818cf8', fontWeight: 700, fontSize: '0.9rem', transform: 'translate(14px, -10px) scale(0.9)', bgcolor: '#030712', px: 1 },
                    }}
                  />
                  <TextField
                    fullWidth label="Password" variant="outlined" required type="password" value={password} onChange={(e) => setPassword(e.target.value)}
                    InputProps={{ 
                      startAdornment: <LockIcon sx={{ mr: 2, color: 'rgba(255,255,255,0.5)', fontSize: 22 }} />,
                    }}
                    InputLabelProps={{ shrink: true }}
                    sx={{ 
                      '& .MuiOutlinedInput-root': { 
